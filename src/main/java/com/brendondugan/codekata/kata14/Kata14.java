...
public class Kata14 {
    public static void main(String[] args){
        Map<String, List<String>> trigrams;
        try {
            File file1 = new File(Kata14.class.getClassLoader().getResource("The Time Machine.txt").toURI());
            TrigramParser parser = new TrigramParser();
            trigrams = parser.parseFile(file1);
            TrigramTextGenerator textGenerator = new TrigramTextGenerator(trigrams, 500);
            String text = textGenerator.buildText();
